...
local function main()
	...
	Explorer.ShowRightClick = function(MousePos)
        ...
        context:AddRegistered("COPY_GS_CODE")
	...
	Explorer.InitRightClick = function()
		...
		context:Register("COPY_GS_CODE",{Name = "Copy GS C", IconMap = Explorer.MiscIcons, Icon = "Copy", DisabledIcon = "Copy_Disabled", Shortcut = "Ctrl+Shift+C", OnClick = function()
			local sList = selection.List
			local targets = {}
